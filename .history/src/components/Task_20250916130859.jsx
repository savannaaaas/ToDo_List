    ...
    >
      <TableCell align="center">
        <Checkbox
          ...
          onChange={handleChangeChecked.bind(null, task.id)} //Создает новую функцию при каждом рендере ()=>handleChangeChecked(task.id), bind обеспечивает с стабильную ссылку
        />
      </TableCell>
      <TableCell
        align="center"
